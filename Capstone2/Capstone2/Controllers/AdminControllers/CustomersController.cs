...
namespace Capstone2.Controllers.AdminControllers
{
    public class CustomersController : GenericController
    {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteConfirmed(int id, bool? fromPastOrders)
        {
            ...
            if (fromPastOrders == true)
            {
                return RedirectToAction(nameof(PastOrders));
            }
            return RedirectToAction(nameof(Index));
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddPayment(int customerId, double paymentAmount, string paymentType)
        {
        ...
        // GET: Customers/PaymentHistory/5
